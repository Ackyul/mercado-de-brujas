...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          <span style={{ fontSize: "0.85rem", fontFamily: "var(--font-serif)", color: "#c084fc", letterSpacing: "0.15em", textTransform: "uppercase" }}>
            ✦ EXPLORA EL AQUELARRE ✦
          </span>
          <h2
            style={{
        ...
        >
          ...
          >
            ...
            <h3 style={{ fontSize: "1.15rem", fontFamily: "var(--font-serif)", color: "#ffffff", margin: 0 }}>
              Hogar
            </h3>
            <p style={{ fontSize: "0.85rem", color: "var(--text-muted)", margin: 0, lineHeight: 1.5 }}>
              Portada principal, ambiente místico e introducción al mercado.
            </p>
          </Link>
          ...
          >
            ...
            <p style={{ fontSize: "0.85rem", color: "var(--text-muted)", margin: 0, lineHeight: 1.5 }}>
              Fechas, boletos, afiches de eventos presenciales y FAQs.
            </p>
          </Link>
          ...
          >
            ...
            <p style={{ fontSize: "0.85rem", color: "var(--text-muted)", margin: 0, lineHeight: 1.5 }}>
              Postulaciones para expositores, artesanos, lecturas y talleres.
            </p>
          </Link>
          ...
          >
            ...
            <p style={{ fontSize: "0.85rem", color: "var(--text-muted)", margin: 0, lineHeight: 1.5 }}>
              Mapa de sedes, cómo llegar, estacionamiento y transporte.
            </p>
          </Link>
          ...
          >
            ...
            <p style={{ fontSize: "0.85rem", color: "var(--text-muted)", margin: 0, lineHeight: 1.5 }}>
              Dress code, memorias fotográficas y unión del aquelarre.
            </p>
          </Link>
        </div>
      </section>
